...
int ctr = 0, ctr2 = 0, playerhp = 5, enemyhp = 5, contest = 0, consecvic = 0, consecvic2 = 0, consectr = 0, spctrbon = 0, ctrbonon = 0, ctrbondef = 0, consecvic3 = 0, spctrbon2 = 0, diceQ2 = 0;
...
int emgspcom5 = 0, emagsup5 = 0, mspatt5 = 0, enspcomb6 = 0, bonrec = 0, magrec = 0, bonrec2 = 0, magrec2 = 0, spmag3 = 0, fghton = 0, fghton2 = 0, new9 = 0, wnct8 = 0, cpuwn8 = 0, magsp4 = 0;
...
{
enemyhp = (enemyhp - 11 * dmg2);//12 //10 12
...
if ((spctrbon > 1) && (dice5 > dice6) && (magsp3 < 1) && (magsp4 < 1) && (ultsp < 4))
{
...
magsp4 = 0;//*THIS IS TO STOP MAGIC SP AND SPECIAL BON FROM PRINTING AT SAME TIME; TRIGGER, MAGSP > 1, FOR SP BON, MAG SP MUST BE LESS THAN < 2!
if (playerhp < 1)
printf("\n");
...
if (diceQ == 2)
printf("     It was a very exciting end to the fight!\n");
if (diceQ == 3)
